                ...
                <div className="max-w-7xl px-2 pb-6 pt-16 sm:px-6 lg:px-8 xl:ms-32">
                    <div className="lg:flex lg:items-center lg:justify-between">
                        ...
                        <p className="mt-4 max-w-md text-center leading-relaxed text-gray-500 sm:text-left lg:mt-0">
                            Code Fun merupakan plaform penyedia informasi seputar kompetisi, bootcamp, workshop, seminar, webinar.
                        </p>
                    </div>

                    <div className="mt-16 grid grid-cols-1 gap-8 border-t border-gray-200 pt-16 md:grid-cols-4 lg:grid-cols-6">
                        <div className="text-center sm:text-left">
                            <p className="text-lg font-medium text-gray-900">About Us</p>

                            <ul className="mt-8 space-y-4 text-sm">
                                <li><a className="text-gray-700 transition hover:text-gray-700/75" href="/">Company History</a></li>
                                <li><a className="text-gray-700 transition hover:text-gray-700/75" href="/"> Meet the Team </a></li>
                                <li><a className="text-gray-700 transition hover:text-gray-700/75" href="/">Employee Handbook</a></li>
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li><a className="text-gray-700 transition hover:text-gray-700/75" href="/"> Web Design </a></li>
                                <li><a className="text-gray-700 transition hover:text-gray-700/75" href="/"> Marketing </a></li>
                                <li><a className="text-gray-700 transition hover:text-gray-700/75" href="/"> Google Ads </a></li>
                            </ul>
                        </div>
                        ...
                        <div className="text-center sm:text-left">
                            ...
                            <ul className="mt-8 space-y-4 text-sm">
                                ...
                                <li><a className="text-gray-700 transition hover:text-gray-700/75" href="/"> Support </a></li>
                            </ul>
                        </div>
                    ...
                    <div className="mt-16 border-t border-gray-200 pt-6 sm:flex sm:items-center sm:justify-between">
                        <p className="text-center text-sm text-gray-500 sm:text-left">
                            Copyright Code Fun &copy; 2022. All rights reserved.
                        </p>
                        ...
                        <ul className="mt-4 flex justify-center gap-6 sm:mt-0 sm:justify-start">
                            ...
                            <li>
                                <a href="/" rel="noreferrer" target="_blank" className="text-teal-700 bg-gradient-to-r from-blue-500 to-teal-400 transition hover:text-teal-700/75">
