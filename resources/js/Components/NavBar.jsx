...
import ScrollProgress from "./UserExperience/ScrollProgress";
import 'preline';
            ...
            <header className="sticky top-0 flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full bg-white border-b border-gray-200 text-sm py-3 sm:py-0 dark:bg-gray-800 dark:border-gray-700">
                <nav className="relative max-w-7xl w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8" aria-label="Global">
                    <div className="flex items-center justify-between">
                        <a className="flex-none text-3xl font-semibold dark:text-white" href="/" aria-label="Brand" type="button"><span className="mb-11 bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400">CodeFun.</span></a>
                    ...
                    <div id="navbar-collapse-with-animation" className="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow sm:block">
                        <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:ps-7">
                            <a className="text-lg font-normal text-blue-600 sm:py-6 dark:text-blue-500" href="/" aria-current="page">Beranda</a>
                            <a className="text-lg font-normal text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="/ourteam">Tentang Kami</a>
                            <a className="text-lg font-normal text-gray-500 hover:text-gray-400 sm:py-6 dark:text-gray-400 dark:hover:text-gray-500" href="/blog">Blog</a>

                            <div className="hs-dropdown [--strategy:static] sm:[--strategy:fixed] [--adaptive:none] sm:[--trigger:hover] sm:py-4">
                                <button type="button" className="text-lg font-normal flex items-center w-full text-gray-500 hover:text-gray-400  dark:text-gray-400 dark:hover:text-gray-500 ">
                                    Lainnya
                            ...
                            <Link href={route('login')}>
                                <a className=" text-lg font-normal flex items-center gap-x-2 te text-gray-500 hover:text-blue-600 sm:border-s sm:border-gray-300 sm:my-6 sm:ps-6 dark:border-gray-700 dark:text-gray-400 dark:hover:text-blue-500" href="#">
