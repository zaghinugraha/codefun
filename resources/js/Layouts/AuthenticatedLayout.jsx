                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden justify-center my-3 xl:mx-72 sm:block">
                                <div class="hidden mx-auto sm:block">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input type="text" id="icon" name="icon" class="py-2 px-4 ps-11 pe-20 block w-92 md:w-96 bg-transparent border-gray-300 shadow-sm rounded-lg text-sm text-gray-800 focus:z-10 focus:border-gray-900 focus:ring-gray-600 placeholder:text-gray-500" placeholder="Mau cari apaaaaa?" />
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <div className="flex flex-row items-center justify-end gap-2">
                                            ...
                                            <div className="z-50 hs-dropdown relative inline-flex" data-hs-dropdown-placement="bottom-right">
                                                <button id="hs-dropdown-with-header" type="button" className="hs-dropdown-toggle w-[2.375rem] h-[2.375rem] inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-full border border-transparent text-gray-500 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                                                    <img className="inline-block h-[2.375rem] w-[2.375rem] rounded-full ring-2 ring-white dark:ring-gray-800" src="https://drive.google.com/uc?export=view&id=12jvkjrSj0l__028gycCqy4hsW0l4HtEN" alt="Image Description" />
                                                </button>
                                            </div>
                                        </div>
                                    </Dropdown.Trigger>
                                    ...
                                    <Dropdown.Content>
                                        <Dropdown.Link href={route('profile.edit')} className='flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600'>
                                        ...
                                        <Dropdown.Link href={route('logout')} method="post" as="button" className="flex items-center gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
